...
public class ModMetadata
{
    ...
    public List<String> authorSkinList = Lists.newArrayList();
    ...
    Set<ArtifactVersion> requiredMods = Sets.newHashSet();
    ...
    public String getAuthorSkinList()
    {
        return Joiner.on(", ").join(authorSkinList);
    }
